<template>
  <div id="introduction" class="section">
    ...
    <p>
      ...
      quarter of Fiscal Year 2019 (FY19 Q3). It is divided into two main
      ...
      with the General Fund. In both sections we present actual data from FY19
      Q3, as well as the projected data for the rest of the current fiscal year.
      All data used in this report is taken directly from the City’s QCMRs. The
      QCMR for FY19 Q3 can be found
      <a
        href="https://www.phila.gov/finance/pdfs/QCMR/QCMR%20ending%203-31-19.pdf"
        target="_blank"
        >here</a
      >.
    </p>
